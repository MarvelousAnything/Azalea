...
void azalea::window::AzaleaWindow::show() { this->m_isShowing = true; }
void azalea::window::AzaleaWindow::hide() { this->m_isShowing = false; }
...
bool azalea::window::AzaleaWindow::isWindowShown() { return this->m_isShowing; }
